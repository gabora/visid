...
caseStudy = 'Circadian';
amigoResFile = 'circadian/circadian_pe_results';
cytoscapeFolder = 'circadian/cytoscape/';
mkdir(cytoscapeFolder)



cramerRaoCorrFile = 'circadian/circadian_corrmat.pdf';
clusterCorrFlag = true;
clusterredCorrFile= 'circadian/circadian_clustCorrmat.pdf';

allLargestSubsetsFlag = true;

costcontourplots_FLAG = false;
costFuncPlotsFolder= 'circadian/costfunction/';
mkdir(costFuncPlotsFolder)

kmax = 3;       % largest correlated group to be searched for
Clim = 20;      % collinearity threshold for the groups

sensitivity_bar_plot_file = 'circadian/circadian_sensitivity_bar.pdf'; 
ci_threshold_idsubsetsize_plot_file = 'circadian/circadian_CI_idsubsetsize.pdf';
